...
0000000000400f43 <phase_3>:
  ...
  400f47:	48 8d 4c 24 0c       	lea    0xc(%rsp),%rcx # b @ 0xc(%rsp)
  400f4c:	48 8d 54 24 08       	lea    0x8(%rsp),%rdx # a @ 0x8(%rsp)
  400f51:	be cf 25 40 00       	mov    $0x4025cf,%esi # "%d %d"
  400f56:	b8 00 00 00 00       	mov    $0x0,%eax
  400f5b:	e8 90 fc ff ff       	callq  400bf0 <__isoc99_sscanf@plt> # (input, "%d %d", &a, &b)
  400f60:	83 f8 01             	cmp    $0x1,%eax
  400f63:	7f 05                	jg     400f6a <phase_3+0x27>
  400f65:	e8 d0 04 00 00       	callq  40143a <explode_bomb>
  400f6a:	83 7c 24 08 07       	cmpl   $0x7,0x8(%rsp) # cmp a, 7
  400f6f:	77 3c                	ja     400fad <phase_3+0x6a> # a > 7, explode
  400f71:	8b 44 24 08          	mov    0x8(%rsp),%eax
  400f75:	ff 24 c5 70 24 40 00 	jmpq   *0x402470(,%rax,8) # 0x402470 is an array of pointers, size = 8
                                # (gdb) x/8xg 0x402470
  ...
  400fbe:	3b 44 24 0c          	cmp    0xc(%rsp),%eax # cmp %eax, b
  400fc2:	74 05                	je     400fc9 <phase_3+0x86> # if not eq, explode
  400fc4:	e8 71 04 00 00       	callq  40143a <explode_bomb>
  400fc9:	48 83 c4 18          	add    $0x18,%rsp
  400fcd:	c3                   	retq

0000000000400fce <func4>: # (int a, int b, int c)
...
000000000040100c <phase_4>:
  ...
  401010:	48 8d 4c 24 0c       	lea    0xc(%rsp),%rcx # b @ 0xc(%rsp)
  401015:	48 8d 54 24 08       	lea    0x8(%rsp),%rdx # a @ 0x8(%rsp)
  40101a:	be cf 25 40 00       	mov    $0x4025cf,%esi # "%d %d"
  40101f:	b8 00 00 00 00       	mov    $0x0,%eax
  401024:	e8 c7 fb ff ff       	callq  400bf0 <__isoc99_sscanf@plt> # (input, "%d %d", &a, &b)
  401029:	83 f8 02             	cmp    $0x2,%eax
  40102c:	75 07                	jne    401035 <phase_4+0x29>
  40102e:	83 7c 24 08 0e       	cmpl   $0xe,0x8(%rsp) # cmp a, 14
  401033:	76 05                	jbe    40103a <phase_4+0x2e>
  401035:	e8 00 04 00 00       	callq  40143a <explode_bomb> # a > 14, explode
  40103a:	ba 0e 00 00 00       	mov    $0xe,%edx # a <= 14, arg 2, 14
  40103f:	be 00 00 00 00       	mov    $0x0,%esi # arg 1, 0
  401044:	8b 7c 24 08          	mov    0x8(%rsp),%edi # arg 0, a
  401048:	e8 81 ff ff ff       	callq  400fce <func4>
  40104d:	85 c0                	test   %eax,%eax # test if result is 0
  40104f:	75 07                	jne    401058 <phase_4+0x4c> # result != 0, explode
  401051:	83 7c 24 0c 00       	cmpl   $0x0,0xc(%rsp) # cmp b, 0
  401056:	74 05                	je     40105d <phase_4+0x51> # if b == 0, return
...
0000000000401062 <phase_5>:
  ...
  40107a:	e8 9c 02 00 00       	callq  40131b <string_length> # string_length(input)
  40107f:	83 f8 06             	cmp    $0x6,%eax
  401082:	74 4e                	je     4010d2 <phase_5+0x70>
  401084:	e8 b1 03 00 00       	callq  40143a <explode_bomb> # len != 6, explode
...
00000000004010f4 <phase_6>:
  ...
  40111e:	83 f8 05             	cmp    $0x5,%eax # cmp eax, 5
  401121:	76 05                	jbe    401128 <phase_6+0x34>
  401123:	e8 12 03 00 00       	callq  40143a <explode_bomb> # if eax > 5 explode
  401128:	41 83 c4 01          	add    $0x1,%r12d # else (eax <= 5), r12d += 1
  40112c:	41 83 fc 06          	cmp    $0x6,%r12d # cmp r12d, 6
  401130:	74 21                	je     401153 <phase_6+0x5f> # break
  401132:	44 89 e3             	mov    %r12d,%ebx # r12d != 6, ebx = r12d
  401135:	48 63 c3             	movslq %ebx,%rax
  401138:	8b 04 84             	mov    (%rsp,%rax,4),%eax # eax = *(rsp + r12d)
  40113b:	39 45 00             	cmp    %eax,0x0(%rbp) # cmp *rbp, eax
  40113e:	75 05                	jne    401145 <phase_6+0x51>
  401140:	e8 f5 02 00 00       	callq  40143a <explode_bomb> # if *rbp == eax, explode
  401145:	83 c3 01             	add    $0x1,%ebx # else (*rbp != eax), ebx += 1
  401148:	83 fb 05             	cmp    $0x5,%ebx # cmp ebx, 5
  ...
  401176:	48 8b 52 08          	mov    0x8(%rdx),%rdx # step in ecx layers for rdx
  40117a:	83 c0 01             	add    $0x1,%eax
  40117d:	39 c8                	cmp    %ecx,%eax
  40117f:	75 f5                	jne    401176 <phase_6+0x82>

  401181:	eb 05                	jmp    401188 <phase_6+0x94> # then go back to 401183 loop
  ...
  40119d:	7e e4                	jle    401183 <phase_6+0x8f> # ecx <= 1, loop continue

  40119f:	b8 01 00 00 00       	mov    $0x1,%eax # ecx > 1, jmp to 401176, which is an inner loop
  4011a4:	ba d0 32 60 00       	mov    $0x6032d0,%edx # same statement as 401183
  4011a9:	eb cb                	jmp    401176 <phase_6+0x82>

  4011ab:	48 8b 5c 24 20       	mov    0x20(%rsp),%rbx # parr[0]
  4011b0:	48 8d 44 24 28       	lea    0x28(%rsp),%rax # p = &parr[1]
  4011b5:	48 8d 74 24 50       	lea    0x50(%rsp),%rsi # end = &parr[6]
  4011ba:	48 89 d9             	mov    %rbx,%rcx # parr[0]
  4011bd:	48 8b 10             	mov    (%rax),%rdx # rdx = *p
...
000000000040145c <read_six_numbers>: # (char *input %rdi, int *arr $rsi)
  40145c:	48 83 ec 18          	sub    $0x18,%rsp
  401460:	48 89 f2             	mov    %rsi,%rdx # arg 2, &arr[0]
  401463:	48 8d 4e 04          	lea    0x4(%rsi),%rcx # arg 3, &arr[1]
  401467:	48 8d 46 14          	lea    0x14(%rsi),%rax
  40146b:	48 89 44 24 08       	mov    %rax,0x8(%rsp) # arg 7, &arr[5]
  401470:	48 8d 46 10          	lea    0x10(%rsi),%rax
  401474:	48 89 04 24          	mov    %rax,(%rsp) # arg 6, &arr[4]
  401478:	4c 8d 4e 0c          	lea    0xc(%rsi),%r9 # arg 5, &arr[3]
  40147c:	4c 8d 46 08          	lea    0x8(%rsi),%r8 # arg 4, &arr[2]
  401480:	be c3 25 40 00       	mov    $0x4025c3,%esi # arg 1, "%d %d %d %d %d %d"
